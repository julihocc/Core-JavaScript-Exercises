...
function memoize(value, context) {
  return function () {
    ...
    console.log("Caching result for ".concat(cacheKey));
    return result;
  };
}
var Example = /*#__PURE__*/function () {
  ...
  _createClass(Example, [{
    ...
    value: function expensiveOperation(arg) {
...
_Example = Example;
var _applyDecs$e = _slicedToArray(_applyDecs(_Example, [[memoize, 2, "expensiveOperation"]], []).e, 1);
