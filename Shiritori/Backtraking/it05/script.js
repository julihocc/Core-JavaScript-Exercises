...
function solution(initArr, m, arr, used, level, print) {
  ...
  for (let curr of arr) {
    ...
    const candidate = [
      curr,
      ...solution(initArr, m, others, used, level, print),
    ];
...
console.log(solution(input, m1, [...input], [], -1, true));

input = ["apple", "elephant", "radio", "tank", "kioto", "ola"];
console.log(solution(input, m1, [...input], [], 0));
