...
var _initClass, _storeDecs, _init_store, _C2;
...
var Container = /*#__PURE__*/function () {
  ...
  _createClass(Container, [{
    key: "register",
    value: function register(injectionKey, value) {
    ...
    value: function lookup(injectionKey) {
      ...
      var hasDependency = this.registry.has(injectionKey);
      if (!hasDependency && optional) {
        console.warn("Optional dependency '".concat(injectionKey, "' not found."));
        return undefined;
      } else if (!hasDependency) {
        throw new Error("Dependency '".concat(injectionKey, "' not found."));
      }
    ...
    value: function create(Class) {
      ...
      var injections = INJECTIONS.get(Class) || [];
      injections.forEach(function (_ref3) {
        var injectionKey = _ref3.injectionKey,
          set = _ref3.set,
          optional = _ref3.optional;
        var dependency = _this.lookup(injectionKey, {
          optional: optional
        });
...
var _createInjections = createInjections(),
  ...
  inject = _createInjections.inject;
_storeDecs = inject("store");
var _C;
...
_C2 = C;
var _applyDecs2 = _applyDecs(_C2, [[_storeDecs, 0, "store"]], [injectable]);
