...
function deepCopyDecorator(value, context) {
  ...
  var originalGetter = value;
  return function () {
    var result = originalGetter.call(this);
    // return JSON.parse(JSON.stringify(result));
    return (0, _deepCopy["default"])(result);
  };
}
...
var Example = /*#__PURE__*/function () {
  function Example() {
    ...
    _classPrivateFieldInitSpec(this, _data, void _initProto(this));
...
_Example = Example;
var _applyDecs$e = _slicedToArray(_applyDecs(_Example, [[deepCopyDecorator, 3, "data"]], []).e, 1);
_initProto = _applyDecs$e[0];
var example = new Example();
var dataCopy = example.data;
