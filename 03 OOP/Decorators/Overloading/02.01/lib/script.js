...
function Overload(value, context) {
  return /*#__PURE__*/function (_value) {
    ...
    _createClass(Overload, [{
      key: "addMethod",
      value: function addMethod(name, methodImplementation) {
        console.log("Adding method ".concat(name));
        console.log("Method implementation ".concat(methodImplementation));
        console.log("Method implementation length ".concat(methodImplementation.length));
        // if (!this.methods[name]) {
        if (!(name in this.methods)) {
          this.methods[name] = {};
        }
        this.methods[name][methodImplementation.length] = methodImplementation.bind(this);
      }
    }, {
      key: "executeMethod",
      value: function executeMethod(name) {
...
function overload(value, context) {
  ...
  addInitializer(function () {
    ...
    console.log("this ".concat(JSON.stringify(this)));
