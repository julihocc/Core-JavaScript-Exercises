...
function withMilk(target) {
  return /*#__PURE__*/function (_target) {
    ...
    _createClass(_class, [{
      key: "cost",
      value: function cost() {
        var newCost = _get(_getPrototypeOf(_class.prototype), "cost", this).call(this) + 1.5;
...
_Coffee2 = Coffee;
var _applyDecs$c = _slicedToArray(_applyDecs(_Coffee2, [], [withMilk]).c, 2);
_Coffee = _applyDecs$c[0];
_initClass = _applyDecs$c[1];
_initClass();
var myCoffee = new _Coffee();
