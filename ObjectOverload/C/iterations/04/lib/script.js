...
var _initProto, _initClass, _MyClass2;
...
function Overload(value) {
  var _methods;
  return _methods = /*#__PURE__*/new WeakMap(), /*#__PURE__*/function (_value) {
    _inherits(Overload, _value);
    function Overload() {
      var _this;
      ...
      _this = _callSuper(this, Overload, [].concat(args));
      _classPrivateFieldInitSpec(_assertThisInitialized(_this), _methods, void 0);
      _this.label = "Overload";
      _classPrivateFieldSet(_methods, _assertThisInitialized(_this), (0, _lodash.cloneDeep)(_this._methods));
      // console.log("this._methods=", this._methods);
      // console.log("this.#methods=", this.#methods);
      delete _this._methods;
      // console.log("this._methods=", this._methods);
      // console.log("this.#methods=", this.#methods);
      return _this;
    }
    _createClass(Overload, [{
      key: "methods",
      get: function get() {
        return _classPrivateFieldGet(_methods, this);
      }
    }, {
      key: "getMethod",
      value: function getMethod(methodName, methodLength) {
        // console.log(`getMethod(${methodName}, ${methodLength})`)
        // console.log(`this.#methods=${JSON.stringify(this.#methods)}`)
        return _classPrivateFieldGet(_methods, this)[methodName][methodLength];
      }
    }, {
      key: "addMethod",
      value: function addMethod(methodName, implementation) {
        if (!this.methods[methodName]) {
          this.methods[methodName] = {};
        }
        this.methods[methodName][implementation.length] = implementation.bind(this);
      }
    }]);
    return Overload;
  }(value);
...
function overload(value, context) {
  ...
  return function () {
    ...
    var method = this.getMethod(name, arguments.length);
    if (method) {
...
_MyClass2 = MyClass;
var _applyDecs2 = _applyDecs(_MyClass2, [[overload, 2, "test"]], [Overload]);
...
_MyClass = _applyDecs2$c[0];
_initClass = _applyDecs2$c[1];
_initClass();
var obj = new _MyClass("Example");
