...
function m2(arr: string[]): number {
  return arr.length;
}

function solution(initArr:string[], m: Function, arr:string[], used: string[], notUsed:string[], level:number, print:boolean): string[] {
